...
<body>
	...
	<nav
		...
		<div class="container">
			<a class="navbar-brand" href="/medico/">Medico</a> <a href="welcome"><h5
					class="text-white mt-2"><%=user.getUserName() %></h5></a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					if(loggedpat ==null){
				%> <a class="btn btn-info" href="completeProfile">Complete
							Profile</a> <%
					}
                %>
					</li>
				...
				<div>
					<form action="paymentGateway" method="post">
						<div class="form-group">
							<label for="dropdownlist1">Specialization</label> <select
								class="form-control" id="dropdownlist1">
						...
						<div class="form-group">
							<label for="dropdownlist2">Doctor</label> <select
								class="form-control" id="dropdownlist2">
								<option value="">Doctor</option>
							</select>
						</div>
						<div class="form-group">
							<label for="dropdownlist3">Time Slot For Video Call</label> <select
								class="form-control" name="timeslotId" id="dropdownlist3">
					...
					<tbody>
						<c:forEach items="${appList}" var="app">
							...
							<tr>
								...
								<td><a class="btn btn-info" href="welcome"
									id="anchor<%=i%>">Appointment Inactive</a></td>
							</tr>
							<%i++;%>
						</c:forEach>
					</tbody>
